...
public class TokenManager : ITokenService
{
    ...
    // HATA KODLARI â€” TokenManager (Prefix: TM)
    // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
    ...
    public async Task AddTokenAsync(Guid userId, int amount, string reason)
    {
        ...
        // Jeton yÃ¼kleme bildirimi â€” await ile, hata loglanÄ±r
        try
        {
            await _publishEndpoint.Publish(new SendNotificationEvent
            {
                UserId = userId,
                Type = "TokenLoaded",
                Title = "Jeton YÃ¼klendi ğŸ’°",
                Message = $"{amount} jeton hesabÄ±nÄ±za yÃ¼klendi. Yeni bakiyeniz: {user.TokenBalance} jeton.",
