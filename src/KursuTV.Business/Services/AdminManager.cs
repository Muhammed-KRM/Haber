...
public class AdminManager : IAdminService
{
    ...
    // HATA KODLARI â€” AdminManager (Prefix: ADM)
    // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
        ...
        if (listing != null)
        {
            ...
            if (listing.Owner != null)
                _ = _publishEndpoint.Publish(new SendNotificationEvent
                {
                    ...
                    Message = $"\"{listing.Title}\" baÅŸlÄ±klÄ± ilanÄ±nÄ±z onaylandÄ± ve yayÄ±nda.",
        ...
        if (listing != null)
        {
            ...
            if (listing.Owner != null)
                _ = _publishEndpoint.Publish(new SendNotificationEvent
                {
                    ...
                    Title = "Ä°lanÄ±nÄ±z Reddedildi âŒ",
                    Message = $"\"{listing.Title}\" baÅŸlÄ±klÄ± ilanÄ±nÄ±z admin tarafÄ±ndan reddedildi. DÃ¼zenleyerek tekrar gÃ¶nderebilirsiniz.",
