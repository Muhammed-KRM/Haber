...
public class SettingManager : ISettingService
{
    ...
    public async Task InitializeDefaultsAsync()
    {
        ...
        {
            ("ListingCreationCost", "5", "Ä°lan oluÅŸturma jeton maliyeti"),
            ("MessageUnlockCost", "1", "Mesaj kilidi aÃ§ma jeton maliyeti"),
            ("DirectOfferCost", "2", "Direkt teklif gÃ¶nderme jeton maliyeti")
        };
