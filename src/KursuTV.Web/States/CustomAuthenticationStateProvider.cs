...
public class CustomAuthenticationStateProvider : AuthenticationStateProvider, ICustomAuthStateProvider
{
    ...
    public override async Task<AuthenticationState> GetAuthenticationStateAsync()
    {
        try
        {
            // Prerendering sÄ±rasÄ±nda JS Ã§aÄŸrÄ±sÄ± yapÄ±lamaz. 
            // Bu hata ProtectedLocalStorage tarafÄ±ndan fÄ±rlatÄ±lÄ±r.
        ...
        {
            // Prerendering sÄ±rasÄ±nda veya hata durumunda anonim kullanÄ±cÄ± dÃ¶ner.
            // Blazor baÄŸlantÄ± kurulduÄŸunda bu metodu tekrar Ã§aÄŸÄ±racaktÄ±r.
            return new AuthenticationState(_anonymous);
        }
    }
