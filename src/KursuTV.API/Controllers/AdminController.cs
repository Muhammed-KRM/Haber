...
public class AdminController : ControllerBase
{
    ...
    // â”€â”€â”€ Sistem AyarlarÄ± â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    [HttpGet("settings")]
    public async Task<IActionResult> GetSettings()
    {
        // Ã–rnek olarak bilinen anahtarlarÄ± dÃ¶ndÃ¼relim (veya tÃ¼mÃ¼nÃ¼ veritabanÄ±ndan Ã§ekelim)
        // Åimdilik DB'den Ã§ekmek daha doÄŸru:
        var settings = new List<KursuTV.Business.DTOs.GlobalSettingDto>
        {
            new() { Key = "ListingCreationCost", Value = await _settingService.GetSettingAsync("ListingCreationCost", "5"), Description = "Ä°lan oluÅŸturma jeton maliyeti" },
            new() { Key = "MessageUnlockCost", Value = await _settingService.GetSettingAsync("MessageUnlockCost", "1"), Description = "Mesaj kilidi aÃ§ma jeton maliyeti" },
            new() { Key = "DirectOfferCost", Value = await _settingService.GetSettingAsync("DirectOfferCost", "2"), Description = "Direkt teklif gÃ¶nderme jeton maliyeti" }
        };
        return Ok(settings);
    }

    [HttpPut("settings")]
    public async Task<IActionResult> UpdateSetting([FromBody] KursuTV.Business.DTOs.GlobalSettingDto dto)
    {
        await _settingService.SetSettingAsync(dto.Key, dto.Value, dto.Description);
        return Ok(new { message = "Ayar gÃ¼ncellendi." });
    }
    ...
    // â”€â”€â”€ KullanÄ±cÄ± YÃ¶netimi â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    [HttpGet("users")]
    ...
    public async Task<IActionResult> SuspendUser(Guid userId)
    {
        ...
        return Ok(new { message = "KullanÄ±cÄ± askÄ±ya alÄ±ndÄ±." });
    }
    ...
    public async Task<IActionResult> ActivateUser(Guid userId)
    {
        ...
        return Ok(new { message = "KullanÄ±cÄ± aktifleÅŸtirildi." });
    }

    // â”€â”€â”€ Ä°lan YÃ¶netimi â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    [HttpGet("listings")]
    ...
    public async Task<IActionResult> ApproveListing(Guid listingId)
    {
        ...
        return Ok(new { message = "Ä°lan onaylandÄ±." });
    }
    ...
    public async Task<IActionResult> RejectListing(Guid listingId)
    {
        ...
        return Ok(new { message = "Ä°lan reddedildi." });
    }
    ...
    public async Task<IActionResult> SuspendListing(Guid listingId)
    {
        ...
        return Ok(new { message = "Ä°lan askÄ±ya alÄ±ndÄ±." });
    }
    ...
    public async Task<IActionResult> DeleteListing(Guid listingId)
    {
        ...
        return Ok(new { message = "Ä°lan silindi." });
    }

    // â”€â”€â”€ Log SorgularÄ± â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€â”€ Moderasyon / Ä°hlal YÃ¶netimi â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    public async Task<IActionResult> BanUser(Guid userId, [FromBody] BanRequestDto dto)
    {
        ...
        return Ok(new { message = "Ban uygulandÄ±." });
    }
    ...
    public async Task<IActionResult> UnbanUser(Guid userId)
    {
        ...
        user.BanReason = null;
        await _db.SaveChangesAsync();
        return Ok(new { message = "Ban kaldÄ±rÄ±ldÄ±." });
    }

    // â”€â”€â”€ SMS Test â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    [HttpPost("test-sms")]
    public async Task<IActionResult> TestSms([FromBody] SmsTestDto dto, [FromServices] ISmsService smsService)
    {
        try
        {
            ...
            return Ok(new { message = "SMS test baÅŸarÄ±lÄ±." });
        }
        catch (Exception ex)
        {
            return BadRequest(new { message = $"SMS test baÅŸarÄ±sÄ±z: {ex.Message}" });
        }
    }

    // â”€â”€â”€ FCM Test â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    [HttpPost("test-fcm")]
    public async Task<IActionResult> TestFcm([FromBody] FcmTestDto dto, [FromServices] KursuTV.Business.Infrastructure.Messaging.IFcmService fcmService)
    {
        try
        {
            await fcmService.SendNotificationAsync(dto.Token, dto.Title, dto.Body);
            return Ok(new { message = "FCM test baÅŸarÄ±lÄ±." });
        }
        catch (Exception ex)
        {
            return BadRequest(new { message = $"FCM test baÅŸarÄ±sÄ±z: {ex.Message}" });
        }
    }
}
